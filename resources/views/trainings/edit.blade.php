...
@section('page-heading', 'Edit Pelatihan')
...
@section('content')
    ...
    <div class="mx-auto max-w-4xl">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <form method="POST" action="{{ route('trainings.update', $training) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <label for="training_category_id" class="block text-sm font-semibold text-slate-700">
                        Kategori Pelatihan
                    </label>

                    <select id="training_category_id" name="training_category_id"
                        ...
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}" @selected(old('training_category_id', $training->training_category_id) == $category->id)>
                                {{ $category->name }}
                            </option>
                        @endforeach
                ...
                <div>
                    ...
                    <input id="name" name="name" type="text" value="{{ old('name', $training->name) }}" required
                        autofocus
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="5"
                        class="mt-2 block w-full rounded-lg border border-slate-300 px-4 py-3 text-sm outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-200">{{ old('description', $training->description) }}</textarea>
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex">
                            ...
                            <span
                                class="inline-flex items-center rounded-l-lg border border-r-0 border-slate-300 bg-slate-50 px-4 text-sm text-slate-500">
                                Rp
                            </span>
                    ...
                    <div>
                        ...
                        <label for="duration_hours" class="block text-sm font-semibold text-slate-700">
                            Durasi
                        </label>

                        <div class="mt-2 flex">

                            <input id="duration_hours" name="duration_hours" type="number" min="1"
                            ...
                            <span
                                class="inline-flex items-center rounded-r-lg border border-l-0 border-slate-300 bg-slate-50 px-4 text-sm text-slate-500">
                                jam
                            </span>
