...
@section('page-heading', 'Edit Kategori Pelatihan')

@section('page-description')
    Perbarui informasi kategori pelatihan.
@endsection
...
@section('content')
    ...
    <div class="mx-auto max-w-3xl">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <form method="POST" action="{{ route('training-categories.update', $trainingCategory) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="name" name="name" type="text" value="{{ old('name', $trainingCategory->name) }}"
                        required autofocus
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="5"
                        class="mt-2 block w-full rounded-lg border border-slate-300 px-4 py-3 text-sm outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-200">{{ old('description', $trainingCategory->description) }}</textarea>
                ...
                <div>
                    ...
                    <label class="inline-flex items-center gap-3">
                        ...
                        <input type="checkbox" name="is_active" value="1" @checked(old('is_active', $trainingCategory->is_active))
